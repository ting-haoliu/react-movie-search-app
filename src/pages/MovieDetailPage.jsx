        ...
        movie && (
          <div className="max-w-4xl mx-auto bg-gray-900 rounded-2xl shadow-lg overflow-hidden">
            ...
            <section className="flex flex-col md:flex-row">
              ...
              {/* Details */}
              <div className="text-left p-6 space-y-4 md:w-2/3">
                <dl className="space-y-4 text-sm text-gray-400">
                  <div>
                    <dt className="font-medium text-gray-200">Runtime</dt>
                    <dd>
                  ...
                  <div>
                    <dt className="font-medium text-gray-200">Release Date</dt>
